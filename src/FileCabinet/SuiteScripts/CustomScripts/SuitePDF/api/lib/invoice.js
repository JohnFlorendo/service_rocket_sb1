        ...
        generate = function (recPrint) {
            ...
            for (var nLine1 = 0; nLine1 < objRecSub.item.length; nLine1++) {
                ...
                if (objRecSub.item[nLine1].item_id == SUBTOTAL) {
                    ...
                    objRecSub.item[nLine1].quantity = Number(objRecSub.item[nLine1].quantity).toFixed(2);
                    objRecSub.item[nLine1].rate = Number(objRecSub.item[nLine1].rate.replace(/,/g, '')).toFixed(2);
                    // objRecSub.item[nLine1].rate = objRecSub.item[nLine1].rate.replace(/,/g, '').replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "1,");
                ...
                objRecSub.item[nLine1].rate = objRecSub.item[nLine1].rate.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                ...
                log.audit("objRecSub.item[nLine1].arrLineDescription", objRecSub.item[nLine1].arrLineDescription);
            }
            ...
            if (nHeaderDiscount) {
                ...
                if (nHeaderDiscount.indexOf('%') > -1) {
                    ...
                    for (var nLine1 = 0; nLine1 < objRecSub.item.length; nLine1++) {
                        ...
                        log.audit(nLine1, objRecSub.item[nLine1]);
