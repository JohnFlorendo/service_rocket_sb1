...
WHERE myapps.isinactive = 'F'
	AND myservrocket.custrecord_msrperm_page = 'parampage'
	AND myapps.custrecord_mya_url IS NOT NULL
...
ORDER BY myapps.custrecord_mya_order